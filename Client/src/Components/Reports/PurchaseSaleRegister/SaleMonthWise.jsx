...
const SaleMonthWise = () => {
    ...
    const API_URL = `${apikey}/api/sugarian/MonthSaleWise_Register`;
   ...
   const handleExportToExcel = () => {
               ...
               const formattedData = reportData.map(item => ({
                   ...
                   "Item Amount": Number(item.itmamount) || 0, 
    ...
    const groupReportData = (data) => {
        ...
        data.forEach((item) => {
            ...
            const subtotal = parseFloat(item.itmamount) || 0;
